...
/* Private defines -----------------------------------------------------------*/
#define DRV_IN1_Pin GPIO_PIN_2
#define DRV_IN1_GPIO_Port GPIOE
#define DRV_IN2_Pin GPIO_PIN_3
#define DRV_IN2_GPIO_Port GPIOE
#define DRV_IN3_Pin GPIO_PIN_4
#define DRV_IN3_GPIO_Port GPIOE
#define DRV_IN4_Pin GPIO_PIN_5
#define DRV_IN4_GPIO_Port GPIOE
#define DRV_nSLEEP_Pin GPIO_PIN_6
#define DRV_nSLEEP_GPIO_Port GPIOE
